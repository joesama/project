...
class CreateProjectFinanceMilestone extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('project_milestone_finance');
        ...
        Schema::create('project_milestone_finance', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('planned', 14, 2)->nullable()->comment('Planned Value');
            $table->unsignedDecimal('actual', 14, 2)->nullable()->comment('Actual Value');
            $table->timestamps();
            $table->softDeletes();
        });
    }
